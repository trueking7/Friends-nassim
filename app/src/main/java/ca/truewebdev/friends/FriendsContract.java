...
public class FriendsContract {
    //create interface that has columns of the friends table
    ...
    public static final String CONTENT_AUTHORITY = "ca.truewebdev.friends.provider";
    ...
    public static class Friends implements FriendsColumns, BaseColumns{
        ...
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd." + CONTENT_AUTHORITY +
                ".friends";

        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd." + CONTENT_AUTHORITY +
                ".friends";

        //build Uri for a particular record
